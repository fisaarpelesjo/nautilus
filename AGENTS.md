...
python main.py funding_cross         # H24 -- cross-exchange funding differential, perp x perp (spec 061)
...
python main.py meta_labeling         # H27 -- meta-labeling, precondition on the primary EMA/RSI signal (spec 064)
...
python main.py dvolgate              # H38 -- implied volatility gate, Deribit DVOL (spec 074)
python main.py pcaeigen              # H39 -- statistical arbitrage via PCA/eigenportfolio (spec 075)
