...
- [ ] T004 Rodar `python main.py fator_tamanho` contra dados reais
- [ ] T005 Registrar o resultado real de T004 em `docs/research/registro-de-hipoteses.md` §6.1 (H30) — "Atualização — testada" no mesmo estilo das demais hipóteses desta rodada
