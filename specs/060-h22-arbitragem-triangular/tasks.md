...
- [ ] T012 Rodar campanha real (≥ 30 ciclos, VPS `vps-limulus`/`nautilus-research`)
- [ ] T013 Registrar o resultado real de T012 em `docs/research/registro-de-hipoteses.md` §6.1 (H22) — "campanha real rodada" no mesmo estilo de H15
- [ ] T014 Rodar a suite completa (`pytest -q`) para confirmar ausência de regressão
