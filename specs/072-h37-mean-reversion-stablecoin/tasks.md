...
- [X] T004 Rodar `python main.py stablecoin` contra dados reais
- [X] T005 Registrar o resultado real de T004 em `docs/research/registro-de-hipoteses.md` §6.1 (H37) — comparação explícita com o resultado original de H3 (FR-004), "Atualização — testada" no mesmo estilo das demais hipóteses desta rodada
