...
- [X] T001 [US1] Teste em `tests/test_main_geometria.py` (novo): função de fração consumida `(sem_custo - com_custo) / sem_custo` produz o mesmo resultado do exemplo já publicado de H10 (+3,96% com custo, +5,56% sem custo → 29% consumido)
